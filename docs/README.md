...
- [Indexer Design](./designs/indexer.md)
- [Query Engine Design](./designs/query-engine.md)
- [Storage Design](./designs/storage.md)
- [CLI Design](./designs/cli.md)
- [Output Format](./designs/output-format.md)

## Roadmaps

- [Roadmap V1](./roadmaps/roadmap-v1.md)
- [Milestones V1](./roadmaps/milestones-v1.md)

## Plans and Spikes

- [README Positioning Plan](./plans/readme-positioning-plan.md)
- [Trust and Evidence Plan](./plans/trust-and-evidence-plan.md)
- [YouTube Demand Response Plan](./plans/youtube-demand-response-plan.md)
- [CLI and Query UX Plan](./plans/cli-and-query-ux-plan.md)

## ADRs

- [ADR 001: Graph Node Model](./adr/adr-001-graph-node-model.md)
- [ADR 002: Storage Backend](./adr/adr-002-storage-backend.md)
- [ADR 003: Symbol Identity](./adr/adr-003-symbol-identity.md)
...
- [Testing Philosophy](./development/testing-philosophy.md)
